<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="page-heading step-num">{l s='Checkout flow'}</h1>
...
<!-- 					<div class="required clearfix gender-line">
					...
					<div class="required form-group"> <!-- Modified -->
						<!-- <label for="lastname">{l s='Last name'} <sup>*</sup></label> -->
						<input type="hidden" value=" " class="form-control validate" id="customer_lastname" name="customer_lastname" onblur="$('#lastname').val($(this).val());" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.customer_lastname) && $guestInformations.customer_lastname}{$guestInformations.customer_lastname}{/if}" />
					</div>
...
<!-- 					<div class="checkbox">
 ...
 -->					{/if}
					...
					<div class="required text form-group"> <!-- modified -->
						<!-- <label for="firstname">{l s='First name'} <sup>*</sup></label> -->
					...
					{elseif $field_name eq "lastname"} <!-- modified -->
					<div class="required text form-group">
						<!-- <label for="lastname">{l s='Last name'} <sup>*</sup></label> -->
						<input type="hidden" value=" " class="text form-control validate" id="lastname" name="lastname" data-validate="isName" value="{if isset($guestInformations) && isset($guestInformations.lastname) && $guestInformations.lastname}{$guestInformations.lastname}{/if}" />
					</div>
					...
					<div class="required text form-group"> <!-- Modified -->
						...
						<input type="hidden" value="Смоленск" class="text form-control validate" name="city" id="city" data-validate="isCityName" value="{if isset($guestInformations) && isset($guestInformations.city) && $guestInformations.city}{$guestInformations.city}{/if}" />
					</div>
					{elseif $field_name eq "country" || $field_name eq "Country:name"}
					<div class="required select form-group unvisible"> <!-- Modified -->
						...
						<!-- <input id="id_country" type="hidden" value="177"> -->
					</div>
					{elseif $field_name eq "state" || $field_name eq 'State:name'}
					{$stateExist = true}
					<div class="required id_state form-group" style="display:none;"> <!-- modified -->
						<div class="unvisible">
							<label for="id_state">{l s='State'} <sup>*</sup></label>
							<select name="id_state" id="id_state" class="form-control">
								<option value="381">Смоленская область</option>
							</select>
						</div>	
					</div>
					{/if}
					...
					{/if}
					{if !$stateExist}
		 			<div class="required id_state form-group unvisible"> <!-- modified -->
		 				<div class="unvisible">
							<label for="id_state">{l s='State'} <sup>*</sup></label>
